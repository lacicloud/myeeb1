...
<head>
  <meta charset="utf-8">
  <title>MyEEB1 Students' Application - About</title>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">MyEEB1 - A centralised space for all your information</h1>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="about-img-box">
            <img src="img eeb1/about.jpg" alt="" class="img-fluid">
          </div>
          <div class="sinse-box">
            <h3 class="sinse-title">Created by students
              <span></span>
              <br> For students</h3>
            <p>Since 2019</p>
          </div>
        ...
        <div class="col-md-12 section-t8">
          <div class="row">
            <div class="col-md-6 col-lg-5">
              <img src="img eeb1/cde.jpg" alt="" class="img-fluid">
            </div>

            <div class="col-md-6 col-lg-5 section-md-t3">
              <div class="title-box-d">
                <h3 class="title-d">My<span class="color-d">EEB1</span> application</h3>
              </div>

              <p class="color-text-a">
                This project is an attempt to create a personalised space where each student has access not only to information regarding his or her own personal 
                profile, but also global information regarding the many services offered by the school. This information was spread across multiple websites and pages
                in the past, making it harder to find. We hope this user-friendly design matches the needs of the user. All functions can be found in the navigation bar above, keep in mind that you need an Office365 account to use them. We are currently still in develoment, so please 
                bear with us! If you find any bugs, don't hesitate to report them back to us.
              </p>
              <p class="color-text-a">
              ...
              <br>
                ...
                - Head Developer: Laszlo Molnarfi <a href="https://github.com/lacicloud/"> (CdE President 2018-2019)</a>
                <br>
