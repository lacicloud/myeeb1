...
<head>
  <meta charset="utf-8">
  <title>MyEEB1 Students' Application - Schedule</title>
...
<h2 class="showing_text">Schedule</h2>

<p class="showing_text">Today is:  <span id="today"></span> </p>
<div class="showing_box">
	<span id="schedule_message"></span>
	<br>
	<img style="width: 100%" src="" id="schedule_picture" />
	<br>
	 <script>
	 result = localStorage.getItem('schedule_picture');
	 if(result === null) {
        //pass
     } else {
     	 var img = document.getElementById('schedule_picture');
     	 var schedulePicture = localStorage.getItem('schedule_picture');
   		 img.src = schedulePicture;
     }
	</script>
	<br>
	<div class="upload-btn-wrapper">
  <button class="btn">Upload new schedule picture!</button>
  <input type="file" id="schedule_picture_upload" />	
</div>

	<script>
		var schedulePictureUpload = document.getElementById('schedule_picture_upload');
		var img = document.getElementById('schedule_picture');
		schedulePictureUpload.addEventListener('change', function() {
		    ...
		    fReader.onload = function() {
		        ...
		        localStorage.setItem("schedule_picture", fReader.result);
 ...
 <!--/ footer Star /-->
  ...
  <script>
    ...
    var name_of_day = days[today.getDay() - 1];

    document.getElementById('today').innerHTML = name_of_day;
  </script>
